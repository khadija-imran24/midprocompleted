...
namespace FinalYearProjectManagement
{
    ...
    {
        String connString = @"Data Source=(local);Initial Catalog=ProjectA;Integrated Security=True";
        ...
        private void Evaluations_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
